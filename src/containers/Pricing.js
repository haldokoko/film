    ...
    return (
        <Box sx={{
            ...
            <Typography component="div" variant="h4" align="center" sx={{ margin: 5 }}>
                Start Your Endless Apik Film Experience Now!
            </Typography>
                ...
                <Table aria-label="simple table">
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell></TableCell>
                            <TableCell align="center">
                                <Button onClick={() => onSubscribed('bronze')} variant="contained">Buy now</Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button onClick={() => onSubscribed('gold')} variant="contained">Buy now</Button>
                            </TableCell>
                            <TableCell align="center">
                                <Button onClick={() => onSubscribed('platinum')} variant="contained">Buy now</Button>
                            </TableCell>
                        </TableRow>
                    </TableFooter>
                </Table>
